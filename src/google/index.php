...
if (isset($_SESSION['profile'])) {
    ...
    if ($gClient->getAccessToken()) {
        ...
        $exists = ProfileManager::iDoExist($_SESSION['google_data']['email']);

        if (isset($exists->email)) {
            ProfileManager::setProfileSession($exists, "GOOGLE");
            ...
            $jsonProfile = ProfileManager::saveUpdateProfile($_SESSION['google_data']['email'], $imagePk, $_SESSION['google_data']['given_name'], "000.000.000-00", "00000000", $_SESSION['google_data']['email'], $complemento, "true", "dd/mm/yyyy", -1);
